...
class GSOT3DMem9DoF(BaseDataset):
...
class TrainDatasetWrapper(torch.utils.data.Dataset):
    ...
    def _generate_item(self, frames, prev_frame_bboxes):
        ...
        for i, (bbox, pcd, prev_bbox) in enumerate(zip(frame_bboxes, frame_pcds, prev_frame_bboxes)):
            ...
            bbox_gt_orientation_angle = bbox.orientation.degrees if self.cfg.degree else bbox.orientation.radians
            ...
            bbox_gt = np.array([
                ...
                bbox_gt_orientation_angle * bbox.orientation.axis[0],
                bbox_gt_orientation_angle * bbox.orientation.axis[1],
                bbox_gt_orientation_angle * bbox.orientation.axis[2],
                bbox.wlh[0], bbox.wlh[1], bbox.wlh[2]
            ])
