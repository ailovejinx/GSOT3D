...
class FusionHead(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        self.fc_proposal = (
            ...
            .conv1d(cfg.feat_dim, bn=True)
            .conv1d(cfg.feat_dim, bn=True)
            .conv1d(3 + 3 + 1 + 3, activation=None))
    ...
    def forward(self, input):
        ...
        xyz = input['fusion_xyz']               # B, N, 3
        geo_feat = input['fusion_feats']        # B, C, N
        lwh = input['lwh']                      # B, 3
